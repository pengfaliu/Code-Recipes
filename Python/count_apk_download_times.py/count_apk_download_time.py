...
#Created: 12/15/15
#"""
# 使用crontab的程序从nginx日志中统计 android的app 下载次数，并且发送到大屏幕统计系统
...
ApiServerUrl= r"http://api.xxx.com/screenshow/setdownloadsnum"
NginxLogPath=r'/home/finance/Logs/nginx/www.XXX.com/www.XXX.com_access.log'
